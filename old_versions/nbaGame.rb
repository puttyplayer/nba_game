...
choice1 = rand(8)
teams = ["hornets", "knicks", "heat","nets","cavs", "spurs","celtics","lakers"]
team1 = teams[choice1]
names = ["David Bromberg","Carmelo Anthony","Kevin Durant","Lebron James","Kobe Brynat","Kevin Love","Jermey Lin","Shabazz Napier"]
heights = [112,90,80,71,75,80,68,69]
weights = [200,129,99,220,220,225,230,280]
roster = [1,]
